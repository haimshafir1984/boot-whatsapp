...
- הצגת טבלת המובילים בפעולת `referral_leaderboard` עברה לפורמט RTL יציב יותר: `🏆 מקום 1:`, `🥈 מקום 2:`, `🥉 מקום 3:` במקום `1.`, `2.`, `3.`. שמות שמכילים אנגלית נעטפים ב־Unicode isolation (`LRI/PDI`) כדי למנוע קפיצת נקודות/מספרים כשהודעת WhatsApp מערבבת עברית ואנגלית.
