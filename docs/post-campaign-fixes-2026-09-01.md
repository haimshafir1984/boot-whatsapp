...
**חשוב לדעת:** בסביבה הנוכחית יש לקוח מנוהל אחד פעיל (`be61c10f`) — הסיכון הזה מתממש רק כשיש **יותר מלקוח אחד** על אותו מספר Meta משותף בו-זמנית. אם זה המצב היום, זה לא רלוונטי מיידית. שווה לוודא.
